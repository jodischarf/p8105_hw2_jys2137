...
This problem uses the _FiveThirtyEight_ datasets:`pols-month.csv`, `unemployment.csv`, and `snp.csv`. The following includes steps to clean and merge these into a single data frame using year and month as keys.
